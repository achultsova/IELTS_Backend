...
var TokenService = /** @class */ (function () {
    ...
    TokenService.prototype.generateTokens = function (payload) {
        var accessToken = jwt.sign(payload, process.env.JWT_ACCESS_SECRET, { expiresIn: '10m' });
    ...
    TokenService.prototype.saveToken = function (userId, refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenModel.findOne({ user: userId })];
                    case 1:
                        tokenData = _a.sent();
                        if (tokenData) {
                        ...
                        return [4 /*yield*/, tokenModel.create({ user: userId, refreshToken: refreshToken })];
                    case 2:
                        token = _a.sent();
    ...
    TokenService.prototype.removeToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenModel.deleteOne({ refreshToken: refreshToken })];
                    case 1:
                        tokenData = _a.sent();
    ...
    TokenService.prototype.findToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, tokenModel.findOne({ refreshToken: refreshToken })];
                    case 1:
                        tokenData = _a.sent();
                        return [2 /*return*/, tokenData];
                }
